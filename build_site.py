...
const PAGE=48;
let st={mode:'Teacher',track:'all',sub:'all',cat:'all',type:'all',ask:false,q:'',shown:PAGE};
...
function openModal(p){
 ...
 $('#mc').onclick=()=>{copyText(p.prompt);toast('Prompt copied');const b=$('#mc');b.classList.add('done');b.textContent='✓ Copied!';setTimeout(()=>{b.classList.remove('done');b.textContent='Copy this prompt';},1600);};
